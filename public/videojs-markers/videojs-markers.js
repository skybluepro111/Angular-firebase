...
(function($, videojs, undefined) {
   ...
   function registerVideoJsMarkersPlugin(options) {
      ...
      function createMarkerDiv(marker, duration) {
         ...
         function HtmlFormat(iconPath) {
             var first = "<div class=vjs-marker> <img src='"
             var second = " 'height=16 width=16 class='vjs-marker'></div>"
             return first.concat(iconPath).concat(second); 
         }

         var markerDiv;

         if(marker.text == "test") {
             var markerDiv = $(HtmlFormat("icons/bm_test.png"));
         } else if(marker.text == "review") {
             var markerDiv = $(HtmlFormat("icons/bm_review.png"));
         } else if(marker.text == "question") {
             var markerDiv = $(HtmlFormat("icons/bm_question.png"));
         } else if(marker.text == "important") {
             var markerDiv = $(HtmlFormat("icons/bm_important.png"));
         } else if(marker.text == "audio") {
             var markerDiv = $(HtmlFormat("icons/bm_audio.png"));
         }
